...
module wb_dma_sdram_tb_top #(
    ...
    wb_mux_2to1 #(
        ...
        .m0_adr (m0_adr), .m0_dat_w (m0_dat_w),
        .m0_we  (m0_we),  .m0_stb   (m0_stb),
        .m0_cyc (m0_cyc), .m0_sel   (m0_sel),
        .m0_dat_r (m0_dat_r), .m0_ack (m0_ack),
        .m1_adr (m1_adr), .m1_dat_w (m1_dat_w),
        .m1_we  (m1_we),  .m1_stb   (m1_stb),
        .m1_cyc (m1_cyc), .m1_sel   (m1_sel),
        .m1_dat_r (m1_dat_r), .m1_ack (m1_ack),
        .s_adr (s_adr),   .s_dat_w (s_dat_w),
        .s_we  (s_we),    .s_stb   (s_stb),
        .s_cyc (s_cyc),   .s_sel   (s_sel),
